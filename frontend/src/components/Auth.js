    ...
    <div>
      <form onSubmit={handleSubmit}>
        <Box maxWidth={400} display='flex' flexDirection={'column'} alignItems='center' justifyContent={'center'} boxShadow='10px 10px 20px #ccc' padding={3} margin='auto' marginTop={5} borderRadius={5}>
          ...
          { isSignup && <TextField name='name' onChange={handleChange} value={inputs.name} placeholder='name' margin="normal"></TextField> }
          <TextField type={'email'} name='email' onChange={handleChange} value={inputs.email} placeholder='email' margin="normal"></TextField>
          <TextField type={'password'} name='password' onChange={handleChange} value={inputs.password} placeholder='password' margin="normal"></TextField>
